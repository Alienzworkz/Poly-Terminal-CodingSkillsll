...
## Team Information
**Project Name**: Decentralized Trading Terminal  
**Submission Date**: 30th April 2026  
**Team Members**: [Add your team members here - up to 5 members]
...
| DP Portfolio | 10 stocks, $100k | ~5 | O(n × W) |
| Order Matching | 100 orders | <1 | O(m log n) |
| Block Mining | 10 trades | ~500 | O(2^difficulty) |

### Memory Usage
- Order book: O(n) where n is number of orders
- Blockchain: O(b × t) where b is blocks, t is trades per block
- DP tables: O(n × W) for portfolio optimization
...
**Demonstration Video**: [Add video link if available]
